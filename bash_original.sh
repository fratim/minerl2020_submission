#!/bin/bash
#SBATCH --job-name=original2                    # Job name
...
#SBATCH --output=/scratch/shared/beegfs/frtim/out_org2.txt
#SBATCH --error=/scratch/shared/beegfs/frtim/error_org2.txt
# -------------------------------
...
/usr/bin/xvfb-run -s "-ac -screen 0 1280x1024x24" python train.py --env MineRLObtainDiamondVectorObf-v0 --gpu 0
