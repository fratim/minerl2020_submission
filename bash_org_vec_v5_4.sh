#!/bin/bash
#SBATCH --job-name=org_vec_v5_5                    # Job name
...
#SBATCH --output=/scratch/shared/beegfs/frtim/runs_v2/logs/out_org_vec_v5_5.txt
#SBATCH --error=/scratch/shared/beegfs/frtim/runs_v2/logs/error_org_vec_v5_5.txt
...
export GRADLE_USER_HOME=$tri_scratch_dir/runs_v2/gradles/gradles_org_vec_v5_5

mkdir $GRADLE_USER_HOME 

cd /users/frtim/Code/ma_minerl_vec

/usr/bin/xvfb-run -s "-ac -screen 0 1280x1024x24" python train.py --env MineRLObtainDiamondDenseVectorObf-v0 --gpu 0 --outdir $tri_scratch_dir/runs_v2/out/org_vec_v5_5
